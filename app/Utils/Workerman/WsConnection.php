...
class WsConnection
{
        ...
        $ws_connection->onMessage = function($conn, $data){
            ...
            if(isset($data['data'])){
                ...
                $depth_data = [
                    ...
                    'asks' => array_slice($tick['asks'], 0, 10), //卖出盘口
                ];
    ...
    public function onConnect($con)
    {
        ...
        if ($this->worker_id < 8) {
            ...
            $this->depthTimer = Timer::add(3, [$this, 'sendDepthData'], [], true);
            $this->sendMatchTradeTimer = Timer::add(3, [$this, 'sendMatchTradeData'], [], true);
        }
