...
class AccountLog extends Model
{
    ...
    const COIN_TRADE = 51;
    const WALLETOUT = 99; //用户Apply for currency withdrawal
    const WALLETOUTDONE = 100; //用户Coin withdrawal successful
    ...
    // const WALLET_MICRO_LEVEL_OUT = 206;//秒合约(c2c)转入合约
    // const WALLET_MICRO_LEVEL_IN = 207;//秒合约(c2c)转入合约
    // const WALLET_LEVEL_MICRO_OUT = 208;//合约转入秒合约(c2c)
    // const WALLET_LEVEL_MICRO_IN = 209;//合约转入秒合约(c2c)

    // const WALLET_LEGAL_MICRO_OUT = 206;//资金(c2c)转入秒合约
    // const WALLET_LEGAL_MICRO_IN = 207;//资金(c2c)转入秒合约
    // const WALLET_MICRO_LEGAL_OUT = 208;//秒合约转入资金(c2c)
    // const WALLET_MICRO_LEGAL_IN = 209;//秒合约转入资金(c2c)
    ...
    const MICRO_SECONDS_TIPS = 706; //秒合约下单提示
    ...
    const AGENT_JIE_TC_MONEY = 800;   //代理商结算头寸收益 划转到账
    const AGENT_JIE_SX_MONEY = 801;   //代理商结算手续费收益 划转到账
    ...
    const USER_PROJECT_ORDER_BUY = 1006;
    const USER_PROJECT_ORDER_LIXI = 1007;
    const USER_BORROW_ORDER_RETURN = 1008;
    const USER_BORROW_ORDER_BUY = 1009;
