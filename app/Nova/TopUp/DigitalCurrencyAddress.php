...
class DigitalCurrencyAddress extends Resource
{
    /**
     ...
     */
    public static $model = \App\Models\DigitalCurrencyAddress::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Text::make(__('PaymentAddress'), 'payment_address'),
            Number::make(__('UsdPrice'), 'usd_price')->step('any'),
        ];
    }
    ...
    {
        return __('DigitalCurrencyAddress');
    }
