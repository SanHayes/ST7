...
return array(
    ...
    '用户无效' => 'User invalid',
    '充币记录'=>'Top up record',
    '限价交易的卖出价格不能低于当前价格'=>'Limit trade selling cannot be lower than the current price',
    '限价交易的买入价格不能高于当前价格'=>'The buying price of limit trading cannot be higher than the current price',
    '您有一笔交易未关闭，暂时无法进行交易'=>'You have a transaction that is being closed, and you are temporarily unable to trade.',
    '限价交易的价格必须大于0'=>'The limit transaction price must be greater than 0',
    '选择不在系统范围'=>'Select multiple is not system wide',
    '买入止盈价格不能低于开盘价和当前价格'=>'The buy (long) take profit price cannot be lower than the opening price and the current price',
    '买入止损价格不能高于开盘价和当前价格'=>'The buy (long) stop loss price cannot be higher than the opening price and the current price',
    '卖出（卖空）的止盈价格不能高于开盘价和当前价格'=>'The take-profit price for selling (short selling) cannot be higher than the opening price and current price.',
    '卖出（卖空）的止损价不能低于开盘价和当前价格'=>'The stop loss price for selling (short selling) cannot be lower than the opening price and the current price.',
    '止盈止损价格不能为0'=>'Take profit and stop loss price cannot be 0',
    '手数不能小于'=>'The lot size cannot be less than',
    '手数不能高于'=>'Lot size cannot be higher than',
    '余额不足，不能少于'=>'The balance is insufficient and cannot be less than',
    '（手续费：'=>'(handling fee:',
    '扣除保证金失败'=>'Failed to deduct margin:',
    '扣除手续费失败'=>'Failed to deduct handling fee:',
    '休市'=>'Closed Market',
);
