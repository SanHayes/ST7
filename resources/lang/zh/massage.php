...
return array(
    ...
    '下单数量必须是整数' => '下单数量必须是整数',
    '下单数量必须是' => '下单数量必须是',
    '最大下单数量不能超过' => '最大下单数量不能超过 :micro_max',
    '最小下单数量不能小于' => '最小下单数量不能小于 :micro_min',
    '申请成功' => '申请成功',
    '认证成功，请等待审核' => '认证成功，请等待审核',
    '操作失败:您的信用分不足' => '操作失败：您的信用分不足 :source',
    '操作失败:您有未平仓的交易,操作禁止' => '操作失败：您有未平仓的交易，操作被禁止',
    '支付通道维护,请更换支付方式' => '支付通道维护中，请更换支付方式',
    '您好，您的账户已被锁定，详情请咨询客服。' => '您好，您的账户已被锁定，详情请咨询客服。',
    '您好，您的资金已被锁定，详情请咨询客服。' => '您好，您的资金已被锁定，详情请咨询客服。',
    '用户无效' => '用户无效',
    '充币记录' => '充币记录',
    '限价交易的卖出价格不能低于当前价格' => '限价交易的卖出价格不能低于当前价格',
    '限价交易的买入价格不能高于当前价格' => '限价交易的买入价格不能高于当前价格',
    '您有一笔交易未关闭，暂时无法进行交易' => '您有一笔交易未关闭，暂时无法进行交易',
    '限价交易的价格必须大于0' => '限价交易的价格必须大于 0',
    '选择不在系统范围' => '选择不在系统范围',
    '买入止盈价格不能低于开盘价和当前价格' => '买入止盈价格不能低于开盘价和当前价格',
    '买入止损价格不能高于开盘价和当前价格' => '买入止损价格不能高于开盘价和当前价格',
    '卖出（卖空）的止盈价格不能高于开盘价和当前价格' => '卖出（卖空）的止盈价格不能高于开盘价和当前价格',
    '卖出（卖空）的止损价不能低于开盘价和当前价格' => '卖出（卖空）的止损价不能低于开盘价和当前价格',
    '止盈止损价格不能为0' => '止盈止损价格不能为 0',
    '手数不能小于' => '手数不能小于',
    '手数不能高于' => '手数不能高于',
    '余额不足，不能少于' => '余额不足，不能少于',
    '（手续费：' => '（手续费：',
