...
return array(
    ...
    '用户无效' => 'ユーザーが無効です',
    '充币记录' => 'チャージ履歴',
    '限价交易的卖出价格不能低于当前价格' => '指値注文の売却価格は現在の価格より低くできません',
    '限价交易的买入价格不能高于当前价格' => '指値注文の購入価格は現在の価格より高くできません',
    '您有一笔交易未关闭，暂时无法进行交易' => '未決済の取引があります。しばらく取引できません',
    '限价交易的价格必须大于0' => '指値注文の価格は0より大きくなければなりません',
    '选择不在系统范围' => '選択がシステムの範囲外です',
    '买入止盈价格不能低于开盘价和当前价格' => '買いポジションの利確価格は、始値と現在価格より低くしてはいけません',
    '买入止损价格不能高于开盘价和当前价格' => '買いポジションの損切り価格は、始値と現在価格より高くしてはいけません',
    '卖出（卖空）的止盈价格不能高于开盘价和当前价格' => '売り（ショート）の利確価格は、始値と現在価格より高くしてはいけません',
    '卖出（卖空）的止损价不能低于开盘价和当前价格' => '売り（ショート）の損切り価格は、始値と現在価格より低くしてはいけません',
    '止盈止损价格不能为0' => '利確・損切り価格は0にできません',
    '手数不能小于' => 'ロット数は以下にできません',
    '手数不能高于' => 'ロット数は以上にできません',
    '余额不足，不能少于' => '残高不足、以下にできません',
    '（手续费：' => '（手数料：',
    '扣除保证金失败' => '証拠金の差し引きに失敗しました：',
    '扣除手续费失败' => '手数料の差し引きに失敗しました：',
    '休市' => '取引停止',
